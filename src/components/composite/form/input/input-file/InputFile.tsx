...
const InputFieldDefaultProps: InputFileProps = {
  type: 'text',
  name: '',
  title: '',
  placeholder: '',
...
export default (inputFieldProps: InputFileProps = InputFieldDefaultProps) => {

  const props: InputFileProps = { ...InputFieldDefaultProps, ...inputFieldProps }
